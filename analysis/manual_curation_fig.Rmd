...
grey_vars_df <- mc_df %>%
        ...
        mutate(benchmark_correct = fct_reorder(benchmark_correct,
                                               count, .desc = TRUE)) 
## TODO - Fix issue with NA for query_correct column, mostly Common variants, one for Roche
...
__Notes/ Potential Issues__

1. Low INDEL proportions for ITER, Roche, DRAGEN
...
## Saving to file
```{r}
ggsave(filename = here("figures", "manual_curation.png"), 
