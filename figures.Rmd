...
- [ ] Revise MRG coverage to use Union of SM and SV
...
*TODO* D. Coverage by gene part (exon, introns)   - `analysis/med_genes_characterization.Rmd` update with MRG union
*TODO* E. small var sv and indel size distributions
