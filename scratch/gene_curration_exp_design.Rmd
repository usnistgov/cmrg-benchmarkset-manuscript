...
__Note__: Issues running IGV batch script.  
1. IGV froze when running batch script if the IGV session is loaded by the batch script.  
2. The IGV images get progressively larger with each position, resulting in a lot of white space in the final image.  
3. Image quality: png and jpg are very low quality, unable to export as eps, svg images are strangely cropped.  
